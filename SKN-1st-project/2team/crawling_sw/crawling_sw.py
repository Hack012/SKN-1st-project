...
def crawl_page():
    ...
    for question_btn in question_btns:
        ...
        try:
            ...
            csv_writer.writerow([category_map[category], question, answer.text])
...
for category in category_code:
    ...
    while True:
        ...
        try:
            ...
            next_page_btn = driver.find_element(By.XPATH, f'//*[@id="app"]/div/div/div[2]/div/div/div/div[2]/div[3]/div/ul/li[{3+page_number}]/button')
            next_page_btn.click()
            time.sleep(2)
            page_number += 1
        except Exception as e:
